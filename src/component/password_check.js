    ...
    const fetchUsers = async () => {
      try {
        ...
        const response = await axios({
          ...
          url: "http://ec2-54-180-32-86.ap-northeast-2.compute.amazonaws.com:8080/v1/auth/sign-in",
        ...
        dispatch({
            type: ADD_FRUIT,
            payload: { access: response.data.accessToken, refresh: response.data.refreshToken },
          });
